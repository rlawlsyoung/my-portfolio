...
export const projectData: projectDataType[] = [
  {
    ...
    introduction:
      "TypeScript와 React를 통해 제작한 웹 포트폴리오입니다. <br /> 자기소개, 기술 스택, 프로젝트, 타임라인에 대해 소개합니다.",
  ...
  //   introduction:
  //     "(주)위닝아이와 함께한 인턴십 개인 과제입니다. <br /> 주요 기능으로는 로그인 및 회원가입, 차트, 게시글 작성, 게시글 삭제, 댓글 작성 및 삭제 등이 있습니다."
  //   ,
