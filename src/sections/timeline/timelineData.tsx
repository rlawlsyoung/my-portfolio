...
export const timelineData: timelineDataType[] = [
  ...
  {
    icon: "https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../releases/preview/2013/png/iconmonstr-code-12.png&r=0&g=0&b=0",
    title: "JUSTCODE 부트캠프 6기 수료",
    period: "2022.07 ~ 2022.10",
    introduce: "웹 프론트엔드 개발자 양성 과정",
  },
  {
    icon: "https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../releases/preview/2013/png/iconmonstr-radio-9.png&r=0&g=0&b=0",
    title: "제203특공여단 병장 만기전역",
    period: "2020.03 ~ 2021.10",
    introduce: "육군 제203특공여단에서 통신병으로 복무",
  },
  {
    icon: "https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../releases/preview/2017/png/iconmonstr-education-1.png&r=0&g=0&b=0",
